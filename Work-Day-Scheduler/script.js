...
$(function () {
  ...
  $(".time-block").each(function () {
    ...
    if (hour < currentHour) {
      $(this).removeClass("present future future0 future1 future2 future3 future4 future5").addClass("past");
    } else if (hour === currentHour) {
      $(this).removeClass("past future future0 future1 future2 future3 future4 future5").addClass("present");
    } else {
      $(this).removeClass("past present").addClass(future+future0+future1+future2+future3+future4+future5);
